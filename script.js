...
class QuestApp {
  ...
  async enterSequence(step) {
    ...
    el.missionView?.classList?.remove("rocket-alert-mode", "stealth-wait-mode", "access-granted-mode");
  ...
  enterStealthWait(step) {
    ...
    this.showView("missionView");
    el.missionFrame.hidden = true;
    el.missionView?.classList?.remove("briefing-mode", "briefing-compact", "signal-mode", "signal-compact", "rocket-alert-mode", "access-granted-mode");
  ...
  enterChallenge(step) {
    ...
    el.missionFrame.hidden = true;
    el.missionView?.classList?.add("briefing-mode");
    el.missionView?.classList?.remove("signal-mode", "stealth-wait-mode", "rocket-alert-mode", "access-granted-mode");
  ...
  enterMission(step, options = {}) {
    ...
    el.missionView?.classList?.remove("stealth-wait-mode", "rocket-alert-mode", "access-granted-mode");
